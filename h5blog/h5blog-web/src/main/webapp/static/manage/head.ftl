<#assign config_v="20140830004">
    ...
    <head>
        ...
        <link href="${BASE_PATH}/static/manage/css/bootstrap-reset.css?v=${config_v}" rel="stylesheet">
        <link rel="stylesheet" type="text/css" href="${BASE_PATH}/static/manage/css/gallery.css?v=${config_v}" />
        <!--external css-->
        <link href="${BASE_PATH}/static/manage/assets/font-awesome/css/font-awesome.css?v=${config_v}" rel="stylesheet" />
                            ...
                            <ul class="nav pull-right top-menu">
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                        <span class="username">${SESSION_ADMIN.loginName}</span>
                                        <b class="caret"></b>
                                    </a>
                                    <ul class="dropdown-menu extended logout">
                                        <div class="log-arrow-up"></div>
                                        <li><a href="${BASE_PATH}/manage/common/update.htm"><i class="icon-cog"></i> 修改密码</a></li>
                    ...
                    <div id="sidebar" class="nav-collapse ">
                        ...
                        <ul class="sidebar-menu" id="nav-accordion">
                        	<#list authList as auth>
                        		<li class="">
                        			<a <#if menu="${auth.authorityDesc}">class="active"</#if> href="${BASE_PATH}/manage/${auth.authorityDesc}/list.htm"> <i class="${auth.authorityIcon}"></i> <span>${auth.authorityName}</span></a>
                        		</li>
                        	</#list>	
				</ul>
			</div>
