				...
				<div class="col-xs-12">
					<section class="panel">
	                	...
	                	<div class="panel-body" id="attachment">
	                		 <form id="addHomePath_form" method="post" class="form-horizontal" autocomplete="off" action="${BASE_PATH}/manage/headline/addHome.json">
	                		 	<fieldset>
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">首页路径</label>
                                      <div class="col-sm-5">
                                          <input type="text" style="font-size:15px;width: 300px;" class="form-control" name="homeName"
                                          	placeholder="首页路径" id="homeName"value="${homeName}">
                                          </input>
                                      </div>
	                  		...
	                  		<table class="table table-striped table-advance table-hover">
                            	...
                            	<tbody role="alert" aria-live="polite" aria-relevant="all">
                            		...
                            		<tr class="gradeA odd">
                                    	...
                                    	<td>
                  							<!-- Icons -->
		                                      <a class="fancybox" rel="group" href="${BASE_PATH}/manage/headline/update/${headline.headlineId}.htm">修改</a> | 
		...
		$('#addHomePath_form').ajaxForm({
			...
			success : function(data) {
				if (data.result) {
					...
					showErrors($('#addHomePath_form'),data.errors);
				}
			}
		});
	});	
