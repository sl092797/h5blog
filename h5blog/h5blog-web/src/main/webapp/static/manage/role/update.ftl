                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-4">
                                        <input type="text" class="form-control" name="roleDesc"
                                          	placeholder="角色描述" id="roleDesc" value="${role.roleDesc}">
                                      </div>
                                  </div> 
                                 </fieldset>
                                 <hr>
		...
		$('#update_role_form').ajaxForm({
			...
			success : function(data) {
				if (data.result) {
					...
					showErrors($('#update_role_form'),data.errors);
				}
			}
		});
	});	
