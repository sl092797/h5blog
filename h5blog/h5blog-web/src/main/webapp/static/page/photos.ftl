...
<body class="background_image">
    <div role="navigation" class="zu-top">
        <div class="zg-wrap modal-shifting clearfix" id="zh-top-inner">
            <a href="/" class="zu-top-link-logo" id="zh-top-link-logo" data-za-c="view_home" data-za-a="visit_home" data-za-l="top_navigation_zhihu_logo">LOGO</a>
            <div class="head-nav">
                <span class="menu"> </span>
                <ul class="cl-effect-3">
                    <li><a href="${BASE_PATH}/main/index">微博</a></li>
                    <li class="active"><a href=" ${BASE_PATH}/main/photos">相册</a></li>
                    <li><a href=" ${BASE_PATH}/main/videos">视频</a></li>
                    <li><a href=" ${BASE_PATH}/main/blogs">文章</a></li>
