                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <form id="addMenu_form" method="post" class="form-horizontal" autocomplete="off" action="${BASE_PATH}/manage/leftmenu/add.json">
                              	<fieldset>
		...
		$('#addMenu_form').ajaxForm({
			...
			success : function(data) {
				if (data.result) {
					...
					showErrors($('#addMenu_form'),data.errors);
				}
			}
		});
	});	
