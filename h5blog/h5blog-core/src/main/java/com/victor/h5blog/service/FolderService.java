...
import com.victor.h5blog.constant.FolderConstant;
import com.victor.h5blog.dao.FolderDao;
import com.victor.h5blog.entity.Folder;
import com.victor.h5blog.entity.vo.AdminFolderVo;
...
public class FolderService {
	...
	private String getPathName(HashMap<String, FolderVo> folderMap, String path) {
		...
		try {
			...
			logger.error(path + " - " + StringUtils.join(path.split("#"), ","));
		}
